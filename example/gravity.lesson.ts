...
export default lesson("Gravity: From Newton to Einstein", {
	...
	.columns(
		[
			{
				markdown:
					"Newton's Universal Law of Gravitation describes an attractive force between all masses.",
			},
	...
	.lab("../orbit-lab.js", {
		...
		caption:
			"Adjust the mass of the central star and the velocity of the planet to see different orbital shapes.",
	})
	...
	.lab("../three-body.js", {
		...
		caption:
			"Under Newton's laws, adding just one more body to an orbit creates unpredictable, chaotic motion. Drag the slider to perturb the starting conditions.",
	})

	.note(
		"Einstein's General Relativity didn't just fix the 'instantaneous' problem—it predicted entirely new phenomena, like black holes and gravitational waves, which we now observe regularly.",
	)
