let props = window.__simProps || { starMass: 1000, planetVel: 4.5, showTrails: true };
...
canvas.addEventListener("pointerdown", (e) => {
  ...
  if (Math.hypot(worldPos.x - planet.x, worldPos.y - planet.y) < Math.max(15, 15 / camera.zoom)) {
    dragging = planet;
    planet.vx = 0;
    planet.vy = 0;
    trail = [];
